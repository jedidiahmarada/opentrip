      ...
      <div className='footer-atas'>
        ...
        <div className='footer-appstore'>
          ...
          <div className='img-appstore'>
            <img className='appstore' src='https://pbs.twimg.com/media/E3yy9oxVgAIeyRQ?format=png&name=orig'/>
            <img className='appstore' src='https://pbs.twimg.com/media/E3yy9ovVgAIaWUz?format=png&name=orig'/>
          </div>
        </div>
      </div>
