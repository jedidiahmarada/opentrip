  ...
  return (
    <div className='containerCheckout'>
      ...
      <div className='billCard'>
        ...
        <p className='payKet'>Payment using transfer via ATM, m-Banking or cash deposit. Payments are made to an Open Trip Virtual Account with the payment gateway NICEPAY. You will be automatically verified after making a payment. Your order will be active for 2 hours before it is automatically canceled by our system.</p>
        ...
        <p className='payKet2'>Your personal data will be used to process your order, support your experience throughout this website, and for other purposes described in our privacy policy.</p>
